...
import top.yang.oss.exception.CosClientException;
import top.yang.oss.model.Bucket;
import top.yang.oss.model.Owner;
...
//                    new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8));
        ...
        if (!sanitizeXmlDocument) {
            ...
            try {
                ...
                sanitizedInputStream =
                        new ByteArrayInputStream(listingDoc.getBytes(StandardCharsets.UTF_8));
     ...
     * @return The integer value of the specified string, otherwise -1 if there were any problems parsing the string as an integer.
     */
     ...
     * @return The long value of the specified string, otherwise -1 if there were any problems parsing the string as a long.
     */
     ...
     * @return Null if the specified string was null, or empty, otherwise returns the string the caller passed in.
     */
...
//    }
    ...
    /**
     * Handler for ListAllMyBuckets response XML documents. The document is parsed into {@link Bucket}s available via the {@link #getBuckets()} method.
     */
        ...
        protected void doEndElement(String uri, String name, String qName) {
            if (in("ListAllMyBucketsResult", "Owner")) {
                ...
                if (qName.equals("Name")) {
                    ...
                    LocalDateTime creationDate = DateUtils.parseISO8601Date(getText());
                ...
                } else if (qName.equals("BucketType")) {
...
//
//    /**
//     * Handler for AccessControlList response XML documents. The document is parsed into an {@link AccessControlList} object available via the {@link #getAccessControlList()}
//     * method.
//     */
...
//
//    /**
//     * Handler for CreateBucketConfiguration response XML documents for a bucket. The document is parsed into a String representing the bucket's location, available via the {@link
//     * #getLocation()} method.
//     */
...
//
//        /**
//         * @see com.qcloud.cos.model.CompleteMultipartUploadResult#setExpirationTime(Date)
//         */
//        @Override
//        public void setExpirationTime(Date expirationTime) {
//            if (result != null) {
...
//
//        /**
//         * @see com.qcloud.cos.model.CompleteMultipartUploadResult#setExpirationTimeRuleId(String)
//         */
//        @Override
//        public void setExpirationTimeRuleId(String expirationTimeRuleId) {
//            if (result != null) {
...
//
//    /**
//     * Handler for LoggingStatus response XML documents for a bucket. The document is parsed into an {@link BucketLoggingConfiguration} object available via the {@link
