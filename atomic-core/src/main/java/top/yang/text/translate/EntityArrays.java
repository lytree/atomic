 ...
 */
package top.yang.text.translate;
...
/**
 * Class holding various entity data for HTML and XML - generally for use with the LookupTranslator. All Maps are generated using {@code java.util.Collections.unmodifiableMap()}.
 *
 * @since 1.0
 */
public class EntityArrays {
     ...
     * references</a>. Note that this must be used with {@link #ISO8859_1_ESCAPE} to get the full list of HTML 4.0 character entities.
     */
