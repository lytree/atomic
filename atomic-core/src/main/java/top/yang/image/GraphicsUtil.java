...
public class GraphicsUtil {
    ...
    /**
     * 绘制字符串，默认抗锯齿。<br> 此方法定义一个矩形区域和坐标，文字基于这个区域中间偏移x,y绘制。
     *
     * @param g         {@link Graphics}画笔
     * @param str       字符串
     ...
     * @return 画笔对象
     */
    public static Graphics drawImages(Graphics g, Image img, Point point) {
        return drawImages(g, img,
     ...
     * @return 画笔对象
     */
    public static Graphics drawImages(Graphics g, Image img, Rectangle rectangle) {
