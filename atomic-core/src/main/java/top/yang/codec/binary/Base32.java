...
public class Base32 extends BaseNCodec {
   ...
   * </p>
   * <p>
   * Output is written to {@link Context#buffer Context#buffer} as 8-bit octets, using {@link Context#pos Context#pos} as the buffer position
   * </p>
   *
...
//              case 0 : // impossible, as excluded above
   ...
   * encoder that EOF has been reached, so flush last remaining bytes (if not multiple of 5).
   * </p>
   *
