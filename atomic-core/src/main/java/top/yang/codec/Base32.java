...
/**
 * Base32 - encodes and decodes RFC3548 Base32 (see http://www.faqs.org/rfcs/rfc3548.html )<br> base32就是用32（2的5次方）个特定ASCII码来表示256个ASCII码。<br>
...
public class Base32 {
  ...
  public static String encode(String source) {
    return encode(source, CharsetsUtils.CHARSET_UTF_8);
  }
  ...
  public static String decodeStr(String source) {
    return decodeStr(source, CharsetsUtils.CHARSET_UTF_8);
  }
   ...
   * @return 被加密后的字符串
   */
  public static String decodeStr(String source, String charset) throws UnsupportedEncodingException {
