...
/**
 * Implements the Percent-Encoding scheme, as described in HTTP 1.1 specification. For extensibility, an array of special US-ASCII characters can be specified in order to perform
...
public class PercentCodec implements BinaryEncoder, BinaryDecoder {
    ...
    /**
     * Constructs a Percent coded that will encode all the non US-ASCII characters using the Percent-Encoding while it will not encode all the US-ASCII characters, except for
     * character '%' that is used as escape character for Percent-Encoding.
     */
    public PercentCodec() {
    ...
    /**
     * Constructs a Percent codec by specifying the characters that belong to US-ASCII that should always be encoded. The rest US-ASCII characters will not be encoded, except for
     * character '%' that is used as escape character for Percent-Encoding.
     *
    ...
    /**
     * Inserts a single character into a BitSet and maintains the min and max of the characters of the {@code BitSet alwaysEncodeChars} in order to avoid look-ups when a byte is
     * out of this range.
     *
