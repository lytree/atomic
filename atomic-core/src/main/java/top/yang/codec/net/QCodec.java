 ...
 * text in various portions of a RFC 822 [2] message header, in a manner which is unlikely to confuse existing message handling software.
 * </p>
 * <p>
 * This class is conditionally thread-safe. The instance field for encoding blanks is mutable {@link #setEncodeBlanks(boolean)} but is not volatile, and accesses are not
 * synchronised. If an instance of the class is shared between threads, the caller needs to ensure that suitable synchronisation is used to ensure safe publication of the value
 * between threads, and must not invoke {@link #setEncodeBlanks(boolean)} after initial setup.
 * </p>
 *
...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
     ...
     * @throws DecoderException Thrown if the argument is not a {@code String}. Thrown if a failure condition is encountered during the decode process.
     */
    @Override
