 ...
 * <p>
 * This codec is meant to be a replacement for standard Java classes {@link java.net.URLEncoder} and {@link java.net.URLDecoder} on older Java platforms, as these classes in Java
 * versions below 1.4 rely on the platform's default charset encoding.
 * </p>
 * <p>
...
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
     ...
     */
    private final String charset; // added volatile: see CODEC-232
     ...
     */
    public static byte[] encodeUrl(BitSet urlsafe, final byte[] bytes) {
        if (bytes == null) {
            return null;
        }
        if (urlsafe == null) {
