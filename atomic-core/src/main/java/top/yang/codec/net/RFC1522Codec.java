 ...
 * encoding of non-ASCII text in various portions of a RFC 822 [2] message header, in a manner which is unlikely to confuse existing message handling software.
 * </p>
 * <p>
...
abstract class RFC1522Codec {
     ...
     * <p>
     * This method constructs the "encoded-word" header common to all the RFC 1522 codecs and then invokes {@link #doEncoding(byte[])}  method of a concrete class to perform the
     * specific encoding.
     *
     ...
     * <p>
     * This method processes the "encoded-word" header common to all the RFC 1522 codecs and then invokes {@link #doDecoding(byte[])}  method of a concrete class to perform the
     * specific decoding.
     *
