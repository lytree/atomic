...
public class NetUtil {
    ...
    public static int getUsableLocalPort(int minPort, int maxPort) {
        ...
        throw new NetException("Could not find an available port in the range [{}, {}] after {} attempts", minPort, maxPort, maxPort - minPort);
    }
    ...
    public static TreeSet<Integer> getUsableLocalPorts(int numRequested, int minPort, int maxPort) {
        ...
        if (availablePorts.size() != numRequested) {
            throw new NetException("Could not find {} available  ports in the range [{}, {}]", numRequested, minPort, maxPort);
        }
    ...
    public static Collection<NetworkInterface> getNetworkInterfaces() {
        ...
        CollectionUtils.addAll(collection, networkInterfaces);
        return collection;
    }
    ...
    /**
     * 获取本机网卡IP地址，这个地址为所有网卡中非回路地址的第一个<br> 如果获取失败调用 {@link InetAddress#getLocalHost()}方法获取。<br> 此方法不会抛出异常，获取失败将返回{@code null}<br>
     * <p>
