...
import top.yang.io.IOCase;

/**
 * Useful utilities for working with file filters. It provides access to most file filter implementations in this package so you don't have to import every class you use.
 *
 * @since 1.0
 */
public class FileFilterUtils {
     ...
     * @param offset      the offset within the files to look for the magic number.
     * @return an IOFileFilter that accepts files containing the magic number at the specified offset.
     * @throws IllegalArgumentException if {@code magicNumber} is {@code null} or the empty String, or if offset is a negative number.
     * @see MagicNumberFileFilter
     * @since 2.0
     */
    ...
    /**
     * Decorates a filter to make it ignore CVS directories. Passing in {@code null} will return a filter that accepts everything except CVS directories.
     *
    ...
    /**
     * Decorates a filter to make it ignore SVN directories. Passing in {@code null} will return a filter that accepts everything except SVN directories.
     *
     * @param filter the filter to decorate, null means an unrestricted filter
     * @return the decorated filter, never null
     * @since 1.1
