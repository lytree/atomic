...
public class CopyDirectoryVisitor extends CountingPathVisitor {
     ...
     * <p>
     * We have to call {@link Path#toString()} relative value because we cannot use paths belonging to different FileSystems in the Path methods, usually this leads to {@link
