...
import top.yang.io.UncheckedIOExceptions;
...
public final class PathUtils {
    ...
    /**
     * Reads the BasicFileAttributes from the given path. Returns null instead of throwing {@link UnsupportedOperationException}. Throws {@link UncheckedIOExceptions} instead of
     * {@link IOException}.
     *
    ...
    public static String readString(final Path path, final Charset charset) throws IOException {
        return Files.readString(path, CharsetsUtils.toCharset(charset));
    }
    ...
    public static Path writeString(final Path path, final CharSequence charSequence, final Charset charset, final OpenOption... openOptions)
        ...
        Files.write(path, String.valueOf(charSequence).getBytes(CharsetsUtils.toCharset(charset)), openOptions);
        return path;
    }
