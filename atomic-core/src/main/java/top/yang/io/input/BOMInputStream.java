...
public class BOMInputStream extends ProxyInputStream {
    ...
    /**
     * This method reads and either preserves or skips the first bytes in the stream. It behaves like the single-byte {@code read()} method, either returning a valid byte or -1 to
