...
public final class UrlBuilder implements Builder<String> {
	...
	public static UrlBuilder of(String url) {
		return of(url, CharsetUtils.CHARSET_UTF_8);
	}
	...
	public static UrlBuilder of(String url, Charset charset) {
		...
		return of(UrlUtils.url(StringUtils.trim(url)), charset);
	}
	...
	public String getSchemeWithDefault() {
		return StringUtils.defaultIfEmpty(this.scheme, DEFAULT_SCHEME);
	}
	...
	public String getPathStr() {
		return null == this.path ? StringUtils.SLASH : this.path.build(charset);
	}
	 ...
	 * @param path path节点
	 * @return this
	 * @deprecated 方法重复，请使用{@link #addPath(String)}
	 */
	@Deprecated
	...
	public UrlBuilder setFragment(String fragment) {
		...
		this.fragment = StringUtils.removeStart(fragment, "#");
		return this;
	}
	...
	public URL toURL(URLStreamHandler handler) {
		...
		// path
		fileBuilder.append(StringUtils.defaultIfBlank(getPathStr(), StringUtils.SLASH));
