...
public final class Preconditions {
    ...
    public static void checkState(boolean b, String errorMessageTemplate, char p1) {
        if (!b) {
            throw new IllegalStateException(StringUtils.format(errorMessageTemplate, p1));
        }
    }
    ...
    public static void checkState(boolean b, String errorMessageTemplate, char p1, char p2) {
        if (!b) {
            throw new IllegalStateException(StringUtils.format(errorMessageTemplate, p1, p2));
        }
    }
    ...
    public static void checkState(
            ...
            Object p3) {
        if (!b) {
            throw new IllegalStateException(StringUtils.format(errorMessageTemplate, p1, p2, p3));
        }
    }
    ...
    public static void checkState(
            ...
            Object p4) {
        if (!b) {
            throw new IllegalStateException(StringUtils.format(errorMessageTemplate, p1, p2, p3, p4));
        }
    }
    ...
    public static <T> T checkNotNull(
            ...
            Object... errorMessageArgs) {
        if (reference == null) {
            throw new NullPointerException(StringUtils.format(errorMessageTemplate, errorMessageArgs));
        }
        return reference;
    }
    ...
    public static <T> T checkNotNull(T obj, String errorMessageTemplate, char p1) {
        if (obj == null) {
            throw new NullPointerException(StringUtils.format(errorMessageTemplate, p1));
        }
        return obj;
    }
    ...
    public static <T> T checkNotNull(
        ...
        if (obj == null) {
            throw new NullPointerException(StringUtils.format(errorMessageTemplate, p1, p2));
        }
        return obj;
    }
    ...
    public static <T> T checkNotNull(
            ...
            Object p3) {
        if (obj == null) {
            throw new NullPointerException(StringUtils.format(errorMessageTemplate, p1, p2, p3));
        }
        return obj;
    }
    ...
    public static <T> T checkNotNull(
            ...
            Object p4) {
        if (obj == null) {
            throw new NullPointerException(StringUtils.format(errorMessageTemplate, p1, p2, p3, p4));
        }
        return obj;
    }
    ...
    /**
     * Ensures that {@code index} specifies a valid <i>element</i> in an array, list or string of size {@code size}. An element index may range from zero, inclusive, to {@code
     * size}, exclusive.
     *
    ...
    private static String badElementIndex(int index, int size, String desc) {
        if (index < 0) {
            ...
            return StringUtils.format("%s (%s) must be less than size (%s)", desc, index, size);
        }
    }

    /**
     * Ensures that {@code index} specifies a valid <i>position</i> in an array, list or string of size {@code size}. A position index may range from zero to {@code size},
     * inclusive.
     *
    ...
    private static String badPositionIndex(int index, int size, String desc) {
        if (index < 0) {
            ...
            return StringUtils.format("%s (%s) must not be greater than size (%s)", desc, index, size);
        }
    }

    /**
     * Ensures that {@code start} and {@code end} specify valid <i>positions</i> in an array, list or string of size {@code size}, and are in order. A position index may range from
     ...
     * @param size  the size of that array, list or string
     * @throws IndexOutOfBoundsException if either index is negative or is greater than {@code size}, or if {@code end} is less than {@code start}
     * @throws IllegalArgumentException  if {@code size} is negative
     */
    ...
    private static String badPositionIndexes(int start, int end, int size) {
        ...
        // end < start
        return StringUtils.format("end index (%s) must not be less than start index (%s)", end, start);
    }
}
