...
import static top.yang.base.Preconditions.checkState;

import java.time.Duration;
import java.util.concurrent.TimeUnit;

/**
 * An object that accurately measures <i>elapsed time</i>: the measured duration between two successive readings of "now" in the same process.
 *
 ...
 * doing so does <i>not</i> give a reliable measurement of elapsed time, because wall time readings are inherently approximate, routinely affected by periodic clock corrections.
 * Because this class (by default) uses {@link System#nanoTime}, it is unaffected by these changes.
 *
...
public final class Stopwatch {
     ...
     * elapsed time. Therefore, we recommend using {@link #elapsed()} instead, which returns a strongly-typed {@code Duration} instance.
     *
