 ...
 * href="https://github.com/google/guava/wiki/CommonObjectUtilitiesExplained">writing {@code Object} methods with {@code MoreObjects}</a>.
 *
...
public final class MoreObjects {
     ...
     * Predicates.notNull())}. For varargs, use {@code Iterables.find(Arrays.asList(a, b, c, ...), Predicates.notNull())}, static importing as necessary.
     *
     * <p><b>Note:</b> if {@code first} is represented as an {@link Optional}, this can be
     * accomplished with {@link Optional#or(Object) first.or(second)}. That approach also allows for lazy evaluation of the fallback instance, using {@link Optional#or(Supplier)
     * first.or(supplier)}.
     *
    ...
    /**
     * Creates an instance of {@link ToStringHelper} in the same manner as {@link #toStringHelper(Object)}, but using {@code className} instead of using an instance's {@link
     * Object#getClass()}.
     *
    ...
    public static final class ToStringHelper {
        ...
        /**
         * Configures the {@link ToStringHelper} so {@link #toString()} will ignore properties with null value. The order of calling this method, relative to the {@code
        ...
        /**
         * Adds a name/value pair to the formatted output in {@code name=value} format. If {@code value} is {@code null}, the string {@code "null"} is used, unless {@link
         ...
         * again and get a more complete representation of the same object; but properties cannot be removed, so this only allows limited reuse of the helper instance. The helper
         * allows duplication of properties (multiple name/value pairs with the same name can be added).
         */
        @Override
        ...
        /**
         * Holder object for values that cannot be null or empty (will be printed unconditionally). This helps to shortcut most calls to isEmpty(), which is important because the
         * check for emptiness is relatively expensive. Use a subtype so this also doesn't need any extra storage.
         */
