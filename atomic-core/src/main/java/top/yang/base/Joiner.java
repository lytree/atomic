 ...
 * Appendable} or returns them as a {@link String}. Example:
 *
 * <pre>{@code
 ...
 * useForNull} has no effect on the instance it is invoked on! You must store and use the new joiner instance returned by the method. This makes joiners thread-safe, and safe to
...
public class Joiner {
    ...
    /**
     * Appends to {@code builder} the string representation of each of the remaining arguments. Identical to {@link #appendTo(Appendable, Object, Object, Object...)}, except that
    ...
    /**
     * An object that joins map entries in the same manner as {@code Joiner} joins iterables and arrays. Like {@code Joiner}, it is thread-safe and immutable.
     *
    ...
    public static final class MapJoiner {
        ...
        /**
         * Appends the string representation of each entry of {@code map}, using the previously configured separator and key-value separator, to {@code builder}. Identical to
