...
final class SmallCharMatcher extends NamedFastMatcher {
    ...
    /**
     * Returns an array size suitable for the backing array of a hash table that uses open addressing with linear probing in its implementation. The returned size is the smallest
     * power of two that can hold setSize elements with the desired load factor.
     */
