...
public class ArrayUtils {
  ...
  /**
   * The index value when an element is not found in a list or array: {@code -1}. This value is returned by methods in this class and can also be used in comparisons with values
   * returned by various method from {@link java.util.List}.
   */
   ...
   * @return A new array containing the existing elements plus the new element The returned array type will be that of the input array (unless null), in which case it will have the
   ...
   * @return The new array, {@code null} if both arrays are {@code null}. The type of the new array is the type of the first array, unless the first array is null, in which case
   ...
   *
   * <p>
   * The new array contains the same elements of the input array plus the given element in the first position. The component type of the new array is the same as that of the input
   * array.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * The new array contains the same elements of the input array plus the given element in the first positioaddFirstaddFirstaddFirstn. The component type of the new array is the
   ...
   *
   * <p>
   * This method will return all the indices of the value which fall between the region defined by valueToFind - tolerance and valueToFind + tolerance, each time between the
   * nearest integers.
   * </p>
   *
   * <p>This method returns an empty BitSet for a {@code null} input array.</p>
