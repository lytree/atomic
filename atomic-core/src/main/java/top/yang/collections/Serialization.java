...
final class Serialization {
     ...
     * distinct elements in a multiset serialized by {@link #writeMultiset(Multiset, ObjectOutputStream)}, or the number of distinct keys in a multimap serialized by {@link
    ...
    /**
     * Stores the contents of a multimap in an output stream, as part of serialization. It does not support concurrent multimaps whose content may change while the method is
     * running. The {@link Multimap#asMap} view determines the ordering in which data is written to the stream.
     *
    ...
    /**
     * Populates a multimap by reading an input stream, as part of deserialization. See {@link #writeMultimap} for the data format. The number of distinct keys is determined by a
