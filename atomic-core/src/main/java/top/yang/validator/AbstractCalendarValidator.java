...
public abstract class AbstractCalendarValidator extends AbstractFormatValidator {
     ...
     *
     * @param value    The value validation is being performed on.
     * @param timeZone The Time Zone used to format the date, system default if null (unless value is a <code>Calendar</code>.
     ...
     *
     * @param value    The value validation is being performed on.
     * @param pattern  The pattern used to validate the value against, or the default for the <code>Locale</code> if <code>null</code>.
     ...
     * @return The parsed value converted to the appropriate type if valid or <code>null</code> if invalid.
     */
    @Override
     ...
     * @return Zero if the first value is equal to the second, -1 if it is less than the second or +1 if it is greater than the second.
     */
     ...
     * @return Zero if the first quarter is equal to the second, -1 if it is less than the second or +1 if it is greater than the second.
     */
     ...
     * first calendar is equal to, less than or greater than the field from the second calendar.
     *
     * @param value   The Calendar value.
     * @param compare The <code>Calendar</code> to check the value against.
     * @param field   The field to compare for the calendars.
     * @return Zero if the first calendar's field is equal to the seconds, -1 if it is less than the seconds or +1 if it is greater than the seconds.
     */
