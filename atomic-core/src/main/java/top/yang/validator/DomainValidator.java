 ...
 * to the standards <a href="http://www.ietf.org/rfc/rfc1034.txt">RFC1034</a>, section 3, and <a href="http://www.ietf.org/rfc/rfc1123.txt">RFC1123</a>, section 2.1. No
 * accommodation is provided for the specialized needs of other applications; if the domain name has been URL-encoded, for example, validation will fail even though the equivalent
 * plaintext version of the same name would have passed.
 * </p>
 *
 * <p>
...
public class DomainValidator implements Serializable {
    ...
    /**
     * Returns a new instance of this validator. The user can provide a list of {@link Item} entries which can be used to override the generic and country code lists. Note that any
     * such entries override values provided by the {@link #updateTLDOverride(ArrayType, String[])} method If an entry for a particular type is not provided, then the class
     ...
     * <p>
     * If allowLocal is true, the TLD is checked using {@link #isValidLocalTld(String)}. The TLD is then checked against {@link #isValidInfrastructureTld(String)}, {@link
    ...
    /**
     * Returns true if the specified <code>String</code> matches any IANA-defined infrastructure top-level domain. Leading dots are ignored if present. The search is
     * case-insensitive.
     *
    ...
    /**
     * Returns true if the specified <code>String</code> matches any IANA-defined country code top-level domain. Leading dots are ignored if present. The search is
     * case-insensitive.
     *
    ...
    /**
     * Returns true if the specified <code>String</code> matches any widely used "local" domains (localhost or localdomain). Leading dots are ignored if present. The search is
     * case-insensitive.
     *
