...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
     ...
     * of the current month (resulting in a number between 1 and 31). This method will retrieve the number of days for any fragment. For example, if you want to calculate the
     * number of days past this year, your fragment is Calendar.YEAR. The result will be all days of the past month(s).</p>
     *
     * <p>Valid fragments are: Calendar.YEAR, Calendar.MONTH, both
