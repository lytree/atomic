...
public final class UnsignedInts {
    ...
    /**
     * Compares the two specified {@code int} values, treating them as unsigned values between {@code 0} and {@code 2^32 - 1} inclusive.
     *
    ...
    /**
     * Returns the {@code int} value that, when treated as unsigned, is nearest in value to {@code value}.
     *
    ...
    /**
     * Returns a string containing the supplied unsigned {@code int} values separated by {@code separator}. For example, {@code join("-", 1, 2, 3)} returns the string {@code
     * "1-2-3"}.
     *
     ...
     * compares, using {@link #compare(int, int)}), the first pair of values that follow any common prefix, or when one array is a prefix of the other, treats the shorter array as
     * the lesser. For example, {@code [] < [1] < [1, 2] < [2] < [1 << 31]}.
     *
