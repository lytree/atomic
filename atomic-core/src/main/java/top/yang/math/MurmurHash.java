...
public class MurmurHash implements Serializable {
    ...
    public static int hash32(String data) {
        return hash32(StringUtils.getBytes(data, DEFAULT_CHARSET));
    }
    ...
    public static long hash64(String data) {
        return hash64(StringUtils.getBytes(data, DEFAULT_CHARSET));
    }
    ...
    public static long[] hash128(String data) {
        return hash128(StringUtils.getBytes(data, DEFAULT_CHARSET));
    }
