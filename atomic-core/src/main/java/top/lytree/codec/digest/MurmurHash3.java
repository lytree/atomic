...
package top.lytree.codec.digest;

/**
 * Implementation of the MurmurHash3 32-bit and 128-bit hash functions.
 *
 * <p>
 * MurmurHash is a non-cryptographic hash function suitable for general hash-based lookup. The name comes from two basic operations, multiply (MU) and rotate (R), used in its inner
 * loop. Unlike cryptographic hash functions, it is not specifically designed to be difficult to reverse by an adversary, making it unsuitable for cryptographic purposes.
 * </p>
 *
 * <p>
 * This contains a Java port of the 32-bit hash function {@code MurmurHash3_x86_32} and the 128-bit hash function {@code MurmurHash3_x64_128} from Austin Applyby's original {@code
 * c++} code in SMHasher.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Original adaption from Apache Hive. That adaption contains a {@code hash64} method that is not part of the original MurmurHash3 code. It is not recommended to use these methods.
 * They will be removed in a future release. To obtain a 64-bit hash use half of the bits from the {@code hash128x64} methods using the input data converted to bytes.
 * </p>
 *
...
public final class MurmurHash3 {
    ...
    public static class IncrementalHash32x86 {
        ...
        /**
         * Combines the bytes using an Or operation ({@code | } in a little-endian representation of a 32-bit integer; byte 1 will be the least significant byte, byte 4 the most
         * significant.
         *
