...
import static top.lytree.math.Doubles.IMPLICIT_BIT;
import static top.lytree.math.Doubles.SIGNIFICAND_BITS;
import static top.lytree.math.Doubles.getSignificand;
import static top.lytree.math.Doubles.isFinite;
import static top.lytree.math.Doubles.isNormal;
import static top.lytree.math.Doubles.scaleNormalize;
import static top.lytree.math.MathPreconditions.checkInRangeForRoundingInputs;
import static top.lytree.math.MathPreconditions.checkNonNegative;
import static top.lytree.math.MathPreconditions.checkRoundingUnnecessary;
...
public class DoubleMath {
     ...
     */
    // #isMathematicalInteger, com.google.common.math.Doubles
     ...
     *                             </ul>
     */
    // #roundIntermediate, java.lang.Math.getExponent, com.google.common.math.Doubles
     ...
     * {@code k}.
     */
    // com.google.common.math.Doubles
     ...
     *                                  infinite
     */
    // java.lang.Math.getExponent, com.google.common.math.Doubles
    @SuppressWarnings("fallthrough")
    public static int log2(double x, RoundingMode mode) {
        Assert.checkArgument(x > 0.0 && isFinite(x), "x must be positive and finite");
        int exponent = getExponent(x);
        if (!isNormal(x)) {
    ...
    private static double checkFinite(double argument) {
        Assert.checkArgument(isFinite(argument));
        return argument;
    }
