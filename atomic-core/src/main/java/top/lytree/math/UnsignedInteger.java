...
import static top.lytree.math.UnsignedInts.INT_MASK;
import static top.lytree.math.UnsignedInts.compare;
import static top.lytree.math.UnsignedInts.toLong;
...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    /**
     * Returns an {@code UnsignedInteger} corresponding to a given bit representation. The argument is interpreted as an unsigned 32-bit value. Specifically, the sign bit of {@code
     * bits} is interpreted as a normal bit, and all other bits are treated as usual.
     *
    ...
    /**
     * Returns an {@code UnsignedInteger} holding the value of the specified {@code String}, parsed as an unsigned {@code int} value.
     *
    ...
    /**
     * Returns an {@code UnsignedInteger} holding the value of the specified {@code String}, parsed as an unsigned {@code int} value in the specified radix.
     *
     * @throws NumberFormatException if the string does not contain a parsable unsigned {@code int} value
     */
    ...
    /**
     * Returns the value of this {@code UnsignedInteger} as an {@code int}. This is an inverse operation to {@link #fromIntBits}.
     *
    ...
    /**
     * Returns the value of this {@code UnsignedInteger} as a {@code float}, analogous to a widening primitive conversion from {@code int} to {@code float}, and correctly rounded.
     */
    @Override
    ...
    /**
     * Returns the value of this {@code UnsignedInteger} as a {@code float}, analogous to a widening primitive conversion from {@code int} to {@code double}, and correctly
     * rounded.
     */
    @Override
    ...
    /**
     * Compares this unsigned integer to another unsigned integer. Returns {@code 0} if they are equal, a negative number if {@code this < other}, and a positive number if {@code
     * this > other}.
     */
    @Override
    ...
    /**
     * Returns a string representation of the {@code UnsignedInteger} value, in base {@code radix}. If {@code radix < Character.MIN_RADIX} or {@code radix > Character.MAX_RADIX},
