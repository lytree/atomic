...
//  private String[] fontNames = { "宋体", "华文楷体", "黑体", "华文新魏", "华文隶书", "微软雅黑", "楷体_GB2312" };
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:22:36<br/> 创建用户:yellowcong<br/> 机能概要:生成图片对象，并返回
   *
   * @return
   * @throws Exception
   */
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:17:28<br/> 创建用户:yellowcong<br/> 机能概要:将图片转化为 二进制数据
   *
   * @param img
   * @return
   * @throws Exception
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:20:50<br/> 创建用户:yellowcong<br/> 机能概要:将二进制数据转化为文件
   *
   * @param data
   * @param file
   * @throws Exception
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:03:57<br/> 创建用户:yellowcong<br/> 机能概要:生成随机的颜色
   *
   * @return
   */
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:03:20<br/> 创建用户:yellowcong<br/> 机能概要:生成随机的字体
   *
   * @return
   */
  ...
  /**
   * 创建日期:2018年2月6日<br/> 创建时间:下午7:09:49<br/> 创建用户:yellowcong<br/> 机能概要:
   *
   * @return 返回验证码图片上的文本
   */
