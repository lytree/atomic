...
import top.lytree.io.file.PathVisitor;

/**
 * Abstracts the implementation of the {@link FileFilter} (IO), {@link FilenameFilter} (IO), {@link PathFilter} (NIO) interfaces via our own {@link IOFileFilter} interface.
 * <p>
