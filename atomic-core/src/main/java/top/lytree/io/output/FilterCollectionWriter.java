...
import top.lytree.exception.IOListException;
import top.lytree.exception.IOIndexedException;
import top.lytree.io.function.IOConsumer;

/**
 * Abstract class for writing filtered character streams to a {@link Collection} of writers. This is in contrast to {@link FilterWriter} which is backed by a single {@link
 * Writer}.
 * <p>
