...
/**
 * An output stream which triggers an event when a specified number of bytes of data have been written to it. The event can be used, for example, to throw an exception if a maximum
 * has been reached, or to switch the underlying stream type when the threshold is exceeded.
 * <p>
 ...
 * </p>
 * <p>
 * NOTE: This implementation may trigger the event <em>before</em> the threshold is actually reached, since it triggers when a pending write operation would cause the threshold to
 * be exceeded.
 * </p>
 */
public class ThresholdingOutputStream extends OutputStream {
    ...
    /**
     * Returns the underlying output stream, to which the corresponding {@code OutputStream} methods in this class will ultimately delegate.
     *
    ...
    /**
     * Indicates that the configured threshold has been reached, and that a subclass should take whatever action necessary on this event. This may include changing the underlying
     * output stream.
     *
     * @throws IOException if an error occurs.
     */
