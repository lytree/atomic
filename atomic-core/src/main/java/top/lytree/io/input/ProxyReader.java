...
public abstract class ProxyReader extends FilterReader {
    ...
    /**
     * Invoked by the read methods after the proxied call has returned successfully. The number of chars returned to the caller (or -1 if the end of stream was reached) is given as
     * an argument.
     * <p>
    ...
    /**
     * Invoked by the read methods before the call is proxied. The number of chars that the caller wanted to read (1 for the {@link #read()} method, buffer length for {@link
     * #read(char[])}, etc.) is given as an argument.
     * <p>
