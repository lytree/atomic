 ...
 * <p>
 * It is an alternative base class to FilterInputStream to increase reusability, because FilterInputStream changes the methods being called, such as read(byte[]) to read(byte[],
 * int, int).
 * </p>
 * <p>
...
public abstract class ProxyInputStream extends FilterInputStream {
    ...
    /**
     * Invoked by the read methods after the proxied call has returned successfully. The number of bytes returned to the caller (or -1 if the end of stream was reached) is given as
     * an argument.
     * <p>
     ...
     * </p>
     * <p>
     * Note this method is <em>not</em> called from {@link #skip(long)} or {@link #reset()}. You need to explicitly override those methods if you want to add post-processing steps
     * also to them.
     * </p>
     *
    ...
    /**
     * Invoked by the read methods before the call is proxied. The number of bytes that the caller wanted to read (1 for the {@link #read()} method, buffer length for {@link
     * #read(byte[])}, etc.) is given as an argument.
     * <p>
     ...
     * </p>
     * <p>
     * Note this method is <em>not</em> called from {@link #skip(long)} or {@link #reset()}. You need to explicitly override those methods if you want to add pre-processing steps
     * also to them.
     * </p>
     *
