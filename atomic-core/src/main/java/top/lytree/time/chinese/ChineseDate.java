...
import top.lytree.time.DateTime;
import top.lytree.time.DateUtils;
import top.lytree.time.LocalDateUtils;
...
public class ChineseDate {
    ...
    public ChineseDate(final Date date) {
        this(LocalDateUtils.of(date.toInstant()));
    }
    ...
    public String getChineseYear() {
        return NumberChineseFormatter.format(this.year, false);
    }
    ...
    public Date getGregorianDate() {
        return DateUtils.date(getGregorianCalendar());
    }
    ...
    public String toString() {
        //todo
        return String.format("%s%s年 %s%s", getChineseYear(), getChineseMonthName(), getChineseDay());
    }
    ...
    private DateTime lunar2solar(final int chineseYear, final int chineseMonth, final int chineseDay, final boolean isLeapMonth) {
        ...
        return DateUtils.date(((offset + chineseDay - 31) * 86400000L) - 2203804800000L);
    }
