...
public class NamingCase {
    ...
    /**
     * 将驼峰式命名的字符串转换为下划线方式，又称SnakeCase、underScoreCase。<br> 如果转换前的驼峰式命名的字符串为空，则返回空字符串。<br> 规则为：
     * <ul>
     *     <li>单字之间以下划线隔开</li>
    ...
    /**
     * 将驼峰式命名的字符串转换为短横连接方式。<br> 如果转换前的驼峰式命名的字符串为空，则返回空字符串。<br> 规则为：
     * <ul>
     *     <li>单字之间横线线隔开</li>
     *     <li>每个单字的首字母亦用小写字母</li>
     * </ul>
    ...
    public static String toKebabCase(CharSequence str) {
        return toSymbolCase(str, CharUtils.DASHED);
    }
    ...
    public static String toPascalCase(CharSequence name) {
        return StringUtils.upperFirst(toCamelCase(name));
    }

    /**
     * 将下划线方式命名的字符串转换为驼峰式。如果转换前的下划线大写方式命名的字符串为空，则返回空字符串。<br> 规则为：
     * <ul>
     *     <li>单字之间不以空格或任何连接符断开</li>
    ...
    public static String toCamelCase(CharSequence name) {
        return toCamelCase(name, CharUtils.UNDERLINE);
    }
