...
public class ReferenceConverter extends AbstractConverter {
	...
	protected Reference<?> convertInternal(final Class<?> targetClass, final Object value) {
		...
		final Type paramType = TypeUtils.getTypeArgument(targetClass);
		...
		throw new UnsupportedOperationException(StringUtils.format("Unsupport Reference type: {}", targetClass.getName()));
	}
