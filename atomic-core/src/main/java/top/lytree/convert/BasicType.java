...
public enum BasicType {
     ...
     */
    private static final BidiMap<Class<?>, Class<?>> WRAPPER_PRIMITIVE_MAP = new DualHashBidiMap<>();
    ...
    public static Class<?> wrap(final Class<?> clazz, final boolean errorReturnNull) {
        ...
        final Class<?> result = WRAPPER_PRIMITIVE_MAP.inverseBidiMap().get(clazz);
    ...
    public static Set<Class<?>> getPrimitiveSet() {
        return WRAPPER_PRIMITIVE_MAP.inverseBidiMap().keySet();
    }
