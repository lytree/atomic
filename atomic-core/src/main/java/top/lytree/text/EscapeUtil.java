package top.lytree.text;


import top.lytree.base.Filter;
import top.lytree.lang.StringUtils;
import top.lytree.text.escape.Html4Escape;
import top.lytree.text.escape.Html4Unescape;
import top.lytree.text.escape.XmlEscape;
import top.lytree.text.escape.XmlUnescape;
...
public class EscapeUtil {
    ...
    private static final Filter<Character> JS_ESCAPE_FILTER = c -> !(
            Character.isDigit(c)
                    ...
                    || StringUtils.contains(NOT_ESCAPE_CHARS, c)
    );
