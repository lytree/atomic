...
public class ArrayUtils {
    ...
    public static <T> T[] append(T[] buffer, T... newElements) {
        ...
        return insert(buffer.length, buffer, newElements);
    }
    ...
    public static boolean containsAny(final Object[] array, final Object... objectsToFind) {
        return StreamUtil.of(objectsToFind).anyMatch(e -> contains(array, e));
    }
     ...
     * ArrayUtils.insert(index, null, null)      = null
     * ArrayUtils.insert(index, array, null)     = cloned copy of 'array'
     * ArrayUtils.insert(index, null, values)    = nullNull
     * </pre>
     *
     * @param index  the position within {@code array} to insert the new values
     * @param array  the array to insert the values into, may be {@code null}
