...
import static top.lytree.collections.TreeBidiMap.DataElement.KEY;
import static top.lytree.collections.TreeBidiMap.DataElement.VALUE;
...
public class TreeBidiMap<K extends Comparable<K>, V extends Comparable<V>>
     ...
     */
    class Inverse implements Map<K, V> {
