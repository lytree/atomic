package top.lytree.collections.iterators;
...
public class IteratorChain<E> implements Iterator<E> {
     ...
     * <p>
     * This method takes one iterator. The newly constructed iterator will iterate through that iterator. Thus calling this constructor on its own will have no effect other than
     * decorating the input iterator.
     * <p>
    ...
    public void addIterator(final Iterator<? extends E> iterator) {
        checkLocked();
        iteratorChain.add(Assert.notNull(iterator, "iterator"));
    }
    ...
    /**
     * Removes from the underlying collection the last element returned by the Iterator. As with next() and hasNext(), this method calls remove() on the underlying Iterator.
     * Therefore, this method may throw an UnsupportedOperationException if the underlying Iterator does not support this method.
     *
