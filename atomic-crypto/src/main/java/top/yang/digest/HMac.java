...
import top.yang.digest.mac.MacEngineFactory;
 ...
 * 可以与任何迭代散列函数捆绑使用。MD5 和 SHA-1 就是这种散列函数。HMAC 还可以使用一个用于计算和确认消息鉴别值的密钥。<br> 注意：此对象实例化后为非线程安全！
 *
 * @author Looly
 */
...
//  /**
//   * 生成文件摘要，并转为16进制字符串<br> 使用默认缓存大小，见 {@link IOUtils#DEFAULT_BUFFER_SIZE}
//   *
//   * @param file 被摘要文件
//   * @return 摘要
//   */
...
//  }
  ...
  /**
   * 验证生成的摘要与给定的摘要比较是否一致<br> 简单比较每个byte位是否相同
   *
   * @param digest          生成的摘要
