...
public class AsymmetricCrypto extends AbstractAsymmetricCrypto<AsymmetricCrypto> {
    ...
    /**
     * 构造 私钥和公钥同时为空时生成一对新的私钥和公钥<br> 私钥和公钥可以单独传入一个，如此则只能使用此钥匙来做加密或者解密
     *
     * @param algorithm     {@link SymmetricAlgorithm}
    ...
    public AsymmetricCrypto(String algorithm, String privateKeyBase64, String publicKeyBase64) {
        this(algorithm, new Base64().decode(privateKeyBase64), new Base64().decode(publicKeyBase64));
    }
    ...
    /**
     * 获取{@link AlgorithmParameterSpec}<br> 在某些算法中，需要特别的参数，例如在ECIES中，此处为IESParameterSpec
     *
    ...
    /**
     * 设置{@link AlgorithmParameterSpec}<br> 在某些算法中，需要特别的参数，例如在ECIES中，此处为IESParameterSpec
     *
