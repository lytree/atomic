...
import top.yang.crypto.BCUtil;
import top.yang.crypto.CryptoException;
import top.yang.crypto.ECKeyUtil;
...
public class SM2 extends AbstractAsymmetricCrypto<SM2> {
    ...
    /**
     * 用私钥对信息生成数字签名，签名格式为ASN1<br> * 在硬件签名中，返回结果为R+S，可以通过调用{@link top.yang.crypto.SmUtil#rsAsn1ToPlain(byte[])}方法转换之。
     *
     * @param data 加密数据
     * @return 签名
     */
