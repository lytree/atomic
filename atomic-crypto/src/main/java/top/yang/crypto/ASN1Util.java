...
public class ASN1Util {
     ...
     * @return 编码后的bytes
     */
    public static byte[] encodeDer(ASN1Encodable... elements) throws IOException {
     ...
     * @return 编码后的bytes
     */
    public static byte[] encode(String asn1Encoding, ASN1Encodable... elements) throws IOException {
     ...
     * @param elements     ASN.1元素
     */
    public static void encodeTo(String asn1Encoding, OutputStream out, ASN1Encodable... elements) throws IOException {
     ...
     */
    public static ASN1Object decode(InputStream in) throws IOException {
     ...
     */
    public static String getDumpStr(InputStream in) throws IOException {
