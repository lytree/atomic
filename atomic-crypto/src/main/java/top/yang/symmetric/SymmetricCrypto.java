...
//  }
   ...
   * @return 加密后的bytes
   */
  public byte[] encrypt(String data, String charset) throws UnsupportedEncodingException {
   ...
   * @since 4.5.12
   */
  public String encryptHex(String data, String charset) throws UnsupportedEncodingException {
   ...
   * @return 加密后的Base64
   */
  public String encryptBase64(String data, String charset) throws UnsupportedEncodingException {
