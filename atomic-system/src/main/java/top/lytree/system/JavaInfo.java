...
public class JavaInfo implements Serializable {
    ...
    public JavaInfo() throws ExecutionException {
    }
     ...
     */
    private float getJavaVersionAsFloat() throws ExecutionException {
     ...
     */
    private int getJavaVersionAsInt() throws ExecutionException {
        if (JAVA_VERSION == null) {
            return 0;
        }
