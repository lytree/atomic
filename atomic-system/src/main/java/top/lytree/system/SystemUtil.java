...
public class SystemUtil extends SystemPropsUtil {
    ...
    /**
     * 获取Java虚拟机中的{@link MemoryPoolMXBean}列表<br> The Java virtual machine can have one or more memory pools. It may add or remove memory pools during execution.
     *
    ...
    /**
     * 获取Java虚拟机中的{@link MemoryManagerMXBean}列表<br> The Java virtual machine can have one or more memory managers. It may add or remove memory managers during execution.
     *
    ...
    protected static void append(StringBuilder builder, String caption, Object value) {
        builder.append(caption).append(StringUtils.defaultIfEmpty(StringUtils.toString(value), "[n/a]")).append("\n");
    }
}
