...
public class RuntimeInfo implements Serializable {
    ...
    public String toString() {
        ...
        SystemUtil.append(builder, "Max Memory:    ", getMaxMemory());
        SystemUtil.append(builder, "Total Memory:     ", getTotalMemory());
        SystemUtil.append(builder, "Free Memory:     ", getFreeMemory());
        SystemUtil.append(builder, "Usable Memory:     ", getUsableMemory());
