...
import top.yang.lang.RegExUtil;
...
public class LocalDateTimeUtil {
    ...
    public static LocalDateTime parse(CharSequence text, String format) {
        ...
        if (StringUtil.isNotBlank(format)) {
            ...
            if (StringUtil.startsWithIgnoreCase(format, DatePattern.PURE_DATETIME_PATTERN)) {
                final String fraction = StringUtil.removeStart(format, DatePattern.PURE_DATETIME_PATTERN);
