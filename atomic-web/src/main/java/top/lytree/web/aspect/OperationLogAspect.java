...
import top.lytree.web.annotation.OperationLog;
import top.lytree.web.domain.dto.SysLog;
import top.lytree.web.enums.BusinessStatus;
import top.lytree.web.utils.IPUtils;
import top.lytree.web.utils.ServletUtils;
...
public class OperationLogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(top.lytree.web.annotation.OperationLog)")
