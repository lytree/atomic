...
public class PutRequest implements HttpRequest {
    public static Request.Builder put(RequestBody requestBody) {
    ...
    public Request getRequest(String url, Map<String, String> requestBody, MediaTypes mediaTypes) {
        return put(RequestBody.create(JSONUtil.toJSONString(requestBody), MediaType.parse(mediaTypes.getMediaType()))).url(url).build();
    }

    @Override
    public Request getRequest(String url, Map<String, String> requestBody) {
        return put(RequestBody.create(JSONUtil.toJSONString(requestBody), MediaType.parse(MediaTypes.JSON.getMediaType()))).url(url).build();
    }
}
