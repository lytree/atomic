...
import top.lytree.ftp.util.Base64;
import top.lytree.ftp.util.SSLContextUtils;
import top.lytree.ftp.util.SSLSocketUtils;
import top.lytree.ftp.util.TrustManagerUtils;
...
//    ftps        990/udp    ftp protocol, control, over TLS/SSL
     ...
     * by  immediately after creating the socket. The default
